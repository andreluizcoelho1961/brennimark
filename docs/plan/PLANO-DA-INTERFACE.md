...
| 18/09 | ~~Faixa branca na borda direita da página do PDF no visualizador~~ — **era defeito, resolvido na fatia 3**: a moldura branca esticava à coluna com o recuo (961 px) e o desenho tinha a largura sem ele (937 px); 24 px de branco à direita, visíveis em página escura. Teste de navegador tranca | ensaio (fatia 2) |
