...
| 24/09 | **Envio de material acima de ~4,5 MB falha em produção**: o arquivo atravessa a função da Vercel, cujo corpo é cortado em 4,5 MB, e o produto promete 25 MB. Caminho: envio direto ao Storage por URL assinada de upload, com a rota só registrando. Um EPS grande já esbarra nisso | fatia 5 |
