...
>
> Descreve a arquitetura da instalação única, com conteúdo de marca versionado em código. Substituído pelo [ADR-0003](./adr/0003-produto-hospedado-multi-marca.md), que adota
