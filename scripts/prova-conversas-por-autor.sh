#!/usr/bin/env bash
#
# Roda a prova das conversas por autor (fatia 4d, 23/09): ninguém lê a
# conversa de outra pessoa — nem quem administra a conta —, e o autor apaga a
# sua de verdade.
#
...
docker exec -i "$CONTAINER" psql -U postgres -q -f - < "$AQUI/prova-conversas-por-autor.sql"
